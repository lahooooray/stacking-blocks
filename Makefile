...
LDLIBS += -lrt -lpthread
#LDLIBS += -lm
SOURCES = game.c mzapo_phys.c mzapo_parlcd.c serialize_lock.c drawing_words.c leds.c stacking_blocks.c stacking_blocks2.c
...
#SSH_OPTIONS=-o 'ProxyJump=babaylau@postel.felk.cvut.cz'
